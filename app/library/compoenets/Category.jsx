...
const Category = () => {
  ...
  return (
    <div className='flex flex-row justify-between items-center gap-4 flex-wrap'>
        ...
        return <li key={item}
                className={
                    cn('h-[38px] min-w-fit px-3 flex justify-center items-center border border-transparent rounded-lg bg-[rgba(144,144,144,0.2)] hover:bg-[rgba(144,144,144,0.45)] cursor-pointer')
                }>{item}</li>;
        })}
        </ul>
        <div>
