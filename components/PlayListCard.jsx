  ...
  return (
    <article className='h-[240px] cursor-pointer group'>
        <section onClick={onClickCard} className='relative h-[136px]'>
            <Image src={imageSrc || "https://images.unsplash.com/photo-1707833558984-3293e794031c"} fill={true} alt='thumbnail' className='object-cover rounded-md'/>
            <div className='hidden relative group-hover:block bg-gradient-to-b from-[rgba(0,0,0,0.7)] top-0 w-full h-[136px]'>
                ...
                <div onClick={onClickPlay} className='absolute bottom-4 right-4 flex items-center justify-center 
                transform-gpu transition-transform 
                hover:scale-110 bg-[rgba(0,0,0,0.7)] w-[45px] h-[45px] rounded-full
                hover:bg-[rgba(0,0,0,0.9)] pl-[4px]
                '>
