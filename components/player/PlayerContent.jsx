...
import { IoPlayBack, IoPlaySkipBackSharp, IoPlaySkipForwardSharp, IoShuffle, IoVolumeHighOutline } from 'react-icons/io5';
...
const PlayerContent = () => {
    ...
    const [audio, state, controls, ref] = useAudio({
        src: activeSong?.src, //'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
        autoPlay: true,
      });
    ...
    <div className='w-full h-full relative'>
        ...
        <section className='flex flex-row justify-between items-center w-full h-full px-2 lg:px-6'>
            <div className='h-full flex flex-row items-center gap-1 lg:gap-8'>
                ...
                {isLoading ? 
                (<ClipLoader color='#FFF'/>) : state.playing ? (
